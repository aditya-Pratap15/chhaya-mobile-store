          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all text-slate-800"
              />
              {storeData.googleReviewUrl && (
                <a
                  href={storeData.googleReviewUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold shrink-0 flex items-center gap-1.5 transition-colors"
                >
            ...
            <p className="text-[11px] text-slate-400 mt-1">Direct link for customers to post 5-star reviews on your official Google Maps listing.</p>
          </div>
        </div>
